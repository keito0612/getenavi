...
import { IoCameraOutline, IoPersonOutline, IoPencil } from "react-icons/io5";
      ...
      <div className="relative h-32 bg-gray-800">
        {profile?.backgroundImage ? (
          ...
          <div className="flex items-center justify-center h-full">
            <IoCameraOutline className="w-8 h-8 text-gray-600" />
          </div>
        )}
      </div>
        ...
        <div className="absolute -top-10 left-4">
          <div className="w-20 h-20 rounded-full border-2 border-blue-500 bg-gray-800 flex items-center justify-center overflow-hidden">
            {profile?.avatarImage ? (
              ...
              <IoPersonOutline className="w-10 h-10 text-blue-500" />
            )}
          </div>
        </div>
